...
},{"./property":22,"vega-lite/src/aggregate":47,"vega-lite/src/channel":49,"vega-lite/src/mark":52,"vega-lite/src/scale":53,"vega-lite/src/sort":54,"vega-lite/src/timeunit":56,"vega-lite/src/type":57}],10:[function(require,module,exports){
"use strict";
/**
...
exports.ENCODING_CONSTRAINTS = [
    {
        ...
        satisfy: function (encQ, schema, opt) {
            if (encQ.scale) {
                ...
                if ((scale.type === undefined && enumspec_1.isEnumSpec(encQ.type)) || enumspec_1.isEnumSpec(scale.type)) {
                    return true;
                }
    ...
    },
    {
        ...
        satisfy: function (encQ, schema, opt) {
            if (encQ.scale) {
                var type = encQ.type;
                var sType = encoding_1.scaleType(encQ.scale.type, encQ.timeUnit, type);
...
},{"../enumspec":16,"../property":22,"../query/encoding":23,"../schema":35,"../util":37,"./base":10,"vega-lite/src/channel":49,"vega-lite/src/scale":53,"vega-lite/src/type":57}],13:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
            ...
            if (mark === mark_1.Mark.AREA || mark === mark_1.Mark.BAR) {
                for (var _i = 0, encodings_2 = encodings; _i < encodings_2.length; _i++) {
                    ...
                    if ((encQ.channel === channel_1.Channel.X || encQ.channel === channel_1.Channel.Y) && encQ.scale) {
                        var sType = encoding_2.scaleType(encQ.scale.type, encQ.timeUnit, encQ.type);
...
},{"../enumspec":16,"../property":22,"../query/encoding":23,"../util":37,"./base":10,"vega-lite/src/aggregate":47,"vega-lite/src/channel":49,"vega-lite/src/mark":52,"vega-lite/src/scale":53,"vega-lite/src/type":57}],14:[function(require,module,exports){
"use strict";
...
},{"./constraint/constraint":11,"./enumerator":15,"./enumspec":16,"./generate":18,"./model":19,"./modelgroup":20,"./nest":21,"./property":22,"./query/query":25,"./ranking/ranking":34,"./schema":35,"./util":37}],15:[function(require,module,exports){
"use strict";
...
},{"./constraint/encoding":12,"./constraint/spec":13,"./property":22}],16:[function(require,module,exports){
"use strict";
var util_1 = require('./util');
...
},{"./property":22,"./util":37}],18:[function(require,module,exports){
"use strict";
...
},{"./enumspec":16,"./enumspecindex":17,"./property":22,"./query/encoding":23,"./query/shorthand":26,"./query/spec":27,"./util":37,"vega-lite/src/aggregate":47,"vega-lite/src/type":57}],20:[function(require,module,exports){
"use strict";
...
},{"./enumspec":16,"./query/groupby":24,"./query/shorthand":26,"./query/spec":27,"./util":37,"datalib/src/util":8,"vega-lite/src/channel":49}],22:[function(require,module,exports){
"use strict";
var scale_1 = require('vega-lite/src/scale');
(function (Property) {
...
},{"vega-lite/src/scale":53}],23:[function(require,module,exports){
"use strict";
var scale_1 = require('vega-lite/src/scale');
var timeunit_1 = require('vega-lite/src/timeunit');
var type_1 = require('vega-lite/src/type');
...
},{"../enumspec":16,"../util":37,"vega-lite/src/scale":53,"vega-lite/src/timeunit":56,"vega-lite/src/type":57}],24:[function(require,module,exports){
"use strict";
var util_1 = require('datalib/src/util');
var util_2 = require('../util');
...
},{"../util":37,"datalib/src/util":8}],25:[function(require,module,exports){
"use strict";
var config_1 = require('../config');
var generate_1 = require('../generate');
...
},{"../config":9,"../generate":18,"../nest":21,"../ranking/ranking":34,"../util":37,"./encoding":23,"./groupby":24,"./shorthand":26,"./spec":27,"./transform":28}],26:[function(require,module,exports){
"use strict";
var type_1 = require('vega-lite/src/type');
var util_1 = require('datalib/src/util');
...
},{"../enumspec":16,"../property":22,"../util":37,"./spec":27,"datalib/src/util":8,"vega-lite/src/type":57}],27:[function(require,module,exports){
"use strict";
var channel_1 = require('vega-lite/src/channel');
var mark_1 = require('vega-lite/src/mark');
...
},{"../enumspec":16,"../property":22,"../util":37,"vega-lite/src/channel":49,"vega-lite/src/mark":52,"vega-lite/src/stack":55}],28:[function(require,module,exports){
"use strict";
...
},{"../query/encoding":23,"../util":37,"vega-lite/src/aggregate":47,"vega-lite/src/type":57}],30:[function(require,module,exports){
"use strict";
var channel_1 = require('vega-lite/src/channel');
var config_1 = require('../../config');
var shorthand_1 = require('../../query/shorthand');
...
},{"../../config":9,"../../query/shorthand":26,"../../util":37,"./effectiveness":31,"./type":33,"vega-lite/src/channel":49}],31:[function(require,module,exports){
"use strict";
...
},{"./channel":30,"./mark":32}],32:[function(require,module,exports){
"use strict";
var channel_1 = require('vega-lite/src/channel');
var mark_1 = require('vega-lite/src/mark');
var util_1 = require('../../util');
...
},{"../../util":37,"./effectiveness":31,"./type":33,"vega-lite/src/channel":49,"vega-lite/src/mark":52}],33:[function(require,module,exports){
"use strict";
var type_1 = require('vega-lite/src/type');
/**
...
},{"vega-lite/src/type":57}],34:[function(require,module,exports){
"use strict";
...
},{"../modelgroup":20,"./aggregation":29,"./effectiveness/effectiveness":31}],35:[function(require,module,exports){
"use strict";
var type_1 = require('vega-lite/src/type');
...
},{"./config":9,"./util":37,"datalib/src/bins/bins":3,"datalib/src/import/type":5,"datalib/src/stats":6,"vega-lite/src/bin":48,"vega-lite/src/timeunit":56,"vega-lite/src/type":57}],36:[function(require,module,exports){
"use strict";
var channel_1 = require('vega-lite/src/channel');
var scale_1 = require('vega-lite/src/scale');
var type_1 = require('vega-lite/src/type');
...
},{"./config":9,"./query/encoding":23,"./util":37,"vega-lite/src/channel":49,"vega-lite/src/scale":53,"vega-lite/src/type":57}],37:[function(require,module,exports){
"use strict";
var util_1 = require('datalib/src/util');
...
},{"../time":41,"../util":42,"dup":3}],40:[function(require,module,exports){
arguments[4][4][0].apply(exports,arguments)
},{"./util":42,"dup":4}],41:[function(require,module,exports){
arguments[4][7][0].apply(exports,arguments)
},{"d3-time":38,"dup":7}],42:[function(require,module,exports){
(function (Buffer){
var u = module.exports;
...
},{"./channel":49}],49:[function(require,module,exports){
/*
...
},{"./channel":49,"./util":58}],52:[function(require,module,exports){
"use strict";
(function (Mark) {
...
},{"./channel":49,"./encoding":51,"./mark":52,"./util":58}],56:[function(require,module,exports){
"use strict";
var channel_1 = require('./channel');
...
},{"./channel":49,"./datetime":50,"./scale":53,"./util":58}],57:[function(require,module,exports){
...
},{"datalib/src/bins/bins":39,"datalib/src/generate":40,"datalib/src/util":42,"json-stable-stringify":43}]},{},[14])(14)
});
