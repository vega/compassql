...
var SpecQueryModel = (function () {
    ...
    SpecQueryModel.prototype.toShorthand = function (include, replace) {
        if (include === void 0) { include = shorthand_1.INCLUDE_ALL; }
        if (replace === void 0) { replace = {}; }
        return shorthand_1.spec(this._spec, include, replace);
    };
