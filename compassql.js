...
},{"../enumspec":16,"../property":21,"../query/encoding":22,"../schema":34,"../util":36,"./base":10,"vega-lite/src/aggregate":42,"vega-lite/src/channel":45,"vega-lite/src/scale":51,"vega-lite/src/type":55}],13:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"./enumspec":16,"./enumspecindex":17,"./property":21,"./query/encoding":22,"./query/groupby":23,"./query/shorthand":25,"./query/spec":26,"./util":36,"vega-lite/src/aggregate":42,"vega-lite/src/type":55}],20:[function(require,module,exports){
"use strict";
var channel_1 = require('vega-lite/src/channel');
...
function isOneOfFilter(filter) {
    return filter && !!filter.field && (util_1.isArray(filter.oneOf) ||
        util_1.isArray(filter.in) // backward compatability
    );
}
