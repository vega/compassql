...
},{"./property":21,"vega-lite/src/aggregate":44,"vega-lite/src/channel":46,"vega-lite/src/mark":49,"vega-lite/src/scale":50,"vega-lite/src/timeunit":52,"vega-lite/src/type":53}],10:[function(require,module,exports){
"use strict";
/**
...
},{"../enumspec":16,"../property":21,"../query/encoding":22,"../schema":33,"../util":34,"./base":10,"vega-lite/src/channel":46,"vega-lite/src/scale":50,"vega-lite/src/type":53}],13:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
        ...
        satisfy: function (specM, schema, opt) {
            ...
            for (var _i = 0, encodings_2 = encodings; _i < encodings_2.length; _i++) {
                ...
                if (encQ.bin && encQ.scale) {
                    if ((encQ.bin === true) && encQ.scale.zero === true) {
                        return false;
                    }
                }
            }
        ...
        satisfy: function (specM, schema, opt) {
            ...
            if (hasAutoCount) {
                ...
                var neverHaveAutoCount = util_1.every(specM.enumSpecIndex.autoCount, function (indexTuple) {
                    return !enumspec_1.isEnumSpec(specM.getEncodingQueryByIndex(indexTuple.index).autoCount);
                });
    ...
    },
    {
        ...
        satisfy: function (specM, schema, opt) {
            ...
            if (mark === mark_1.Mark.AREA || mark === mark_1.Mark.BAR) {
                for (var _i = 0, encodings_3 = encodings; _i < encodings_3.length; _i++) {
                    var encQ = encodings_3[_i];
                    if ((encQ.channel === channel_1.Channel.X || encQ.channel === channel_1.Channel.Y) && encQ.scale) {
                        var sType = encoding_1.scaleType(encQ.scale.type, encQ.timeUnit, encQ.type);
...
},{"../enumspec":16,"../property":21,"../query/encoding":22,"../util":34,"./base":10,"vega-lite/src/aggregate":44,"vega-lite/src/channel":46,"vega-lite/src/mark":49,"vega-lite/src/scale":50,"vega-lite/src/type":53}],14:[function(require,module,exports){
"use strict";
...
},{"./constraint/constraint":11,"./enumerator":15,"./enumspec":16,"./generate":17,"./model":18,"./modelgroup":19,"./nest":20,"./property":21,"./query/query":24,"./ranking/ranking":32,"./schema":33,"./util":34}],15:[function(require,module,exports){
"use strict";
...
},{"../src/enumerator":15,"./config":9,"./model":18}],18:[function(require,module,exports){
"use strict";
var aggregate_1 = require('vega-lite/src/aggregate');
var type_1 = require('vega-lite/src/type');
var property_1 = require('./property');
        ...
        specQ.encodings.forEach(function (encQ, index) {
            ...
            property_1.ENCODING_PROPERTIES.forEach(function (prop) {
                if (enumspec_1.isEnumSpec(encQ[prop])) {
                    ...
                    encQ[prop] = enumspec_1.initEnumSpec(encQ[prop], defaultEnumSpecName, defaultEnumValues);
            ...
            property_1.NESTED_ENCODING_PROPERTIES.forEach(function (nestedProp) {
                ...
                if (propObj) {
                    ...
                    if (enumspec_1.isEnumSpec(propObj[child])) {
                        ...
                        var defaultEnumSpecName = getDefaultName(prop) + index;
                        var defaultEnumValues = getDefaultEnumValues(prop, schema, opt);
                        propObj[child] = enumspec_1.initEnumSpec(propObj[child], defaultEnumSpecName, defaultEnumValues);
                        // Add index of the encoding mapping to the property's enum job.
                        (enumSpecIndex[prop] = enumSpecIndex[prop] || []).push({
...
},{"./enumspec":16,"./property":21,"./query/encoding":22,"./query/shorthand":25,"./query/spec":26,"./util":34,"vega-lite/src/aggregate":44,"vega-lite/src/type":53}],19:[function(require,module,exports){
"use strict";
...
},{"./enumspec":16,"./query/groupby":23,"./query/shorthand":25,"./query/spec":26,"./util":34,"datalib/src/util":8,"vega-lite/src/channel":46}],21:[function(require,module,exports){
"use strict";
(function (Property) {
...
},{"../enumspec":16,"../util":34,"vega-lite/src/scale":50,"vega-lite/src/timeunit":52,"vega-lite/src/type":53}],23:[function(require,module,exports){
"use strict";
var util_1 = require('datalib/src/util');
var util_2 = require('../util');
...
},{"../util":34,"datalib/src/util":8}],24:[function(require,module,exports){
"use strict";
var config_1 = require('../config');
var generate_1 = require('../generate');
...
},{"../config":9,"../generate":17,"../nest":20,"../ranking/ranking":32,"../util":34,"./encoding":22,"./groupby":23,"./shorthand":25,"./spec":26,"./transform":27}],25:[function(require,module,exports){
"use strict";
var type_1 = require('vega-lite/src/type');
...
},{"../enumspec":16,"../property":21,"../util":34,"./spec":26,"vega-lite/src/type":53}],26:[function(require,module,exports){
"use strict";
var channel_1 = require('vega-lite/src/channel');
var mark_1 = require('vega-lite/src/mark');
...
},{"../enumspec":16,"../property":21,"../util":34,"vega-lite/src/channel":46,"vega-lite/src/mark":49,"vega-lite/src/stack":51}],27:[function(require,module,exports){
"use strict";
...
},{"../../config":9,"../../query/shorthand":25,"../../util":34,"./effectiveness":29,"./type":31,"vega-lite/src/channel":46}],29:[function(require,module,exports){
"use strict";
...
},{"./channel":28,"./mark":30}],30:[function(require,module,exports){
"use strict";
var channel_1 = require('vega-lite/src/channel');
var mark_1 = require('vega-lite/src/mark');
var util_1 = require('../../util');
...
},{"../../util":34,"./effectiveness":29,"./type":31,"vega-lite/src/channel":46,"vega-lite/src/mark":49}],31:[function(require,module,exports){
"use strict";
var type_1 = require('vega-lite/src/type');
/**
...
},{"vega-lite/src/type":53}],32:[function(require,module,exports){
"use strict";
...
},{"../modelgroup":19,"./effectiveness/effectiveness":29}],33:[function(require,module,exports){
"use strict";
var type_1 = require('vega-lite/src/type');
...
},{"./config":9,"./util":34,"datalib/src/bins/bins":3,"datalib/src/import/type":5,"datalib/src/stats":6,"vega-lite/src/bin":45,"vega-lite/src/type":53}],34:[function(require,module,exports){
"use strict";
var util_1 = require('datalib/src/util');
...
},{"datalib/src/util":8}],35:[function(require,module,exports){
arguments[4][2][0].apply(exports,arguments)
},{"dup":2}],36:[function(require,module,exports){
arguments[4][3][0].apply(exports,arguments)
},{"../time":38,"../util":39,"dup":3}],37:[function(require,module,exports){
arguments[4][4][0].apply(exports,arguments)
},{"./util":39,"dup":4}],38:[function(require,module,exports){
arguments[4][7][0].apply(exports,arguments)
},{"d3-time":35,"dup":7}],39:[function(require,module,exports){
(function (Buffer){
var u = module.exports;
...
},{"./channel":46,"./util":54}],49:[function(require,module,exports){
"use strict";
(function (Mark) {
...
},{"./channel":46,"./encoding":48,"./mark":49,"./util":54}],52:[function(require,module,exports){
"use strict";
var channel_1 = require('./channel');
...
},{"./channel":46,"./datetime":47,"./scale":50,"./util":54}],53:[function(require,module,exports){
...
},{"datalib/src/bins/bins":36,"datalib/src/generate":37,"datalib/src/util":39,"json-stable-stringify":40}]},{},[14])(14)
});
