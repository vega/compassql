...
},{"./config":6,"./generate":13,"./nest":16,"./ranking/ranking":23,"./util":25,"vega-lite/src/channel":36,"vega-lite/src/mark":38,"vega-lite/src/stack":40,"vega-lite/src/type":42}],19:[function(require,module,exports){
"use strict";
var channel_1 = require('vega-lite/src/channel');
var config_1 = require('../../config');
var query_1 = require('../../query');
...
var Schema = (function () {
    ...
    Schema.build = function (data) {
        ...
        var fieldSchemas = summaries.map(function (summary) {
            ...
            var type = (primitiveType === PrimitiveType.NUMBER || primitiveType === PrimitiveType.INTEGER) ? type_1.Type.QUANTITATIVE :
                primitiveType === PrimitiveType.DATE ? type_1.Type.TEMPORAL : type_1.Type.NOMINAL;
            return {
                field: field,
                type: type,
...
},{"datalib/src/import/type":3,"datalib/src/stats":4,"vega-lite/src/type":42}],25:[function(require,module,exports){
"use strict";
