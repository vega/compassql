...
},{"./property":13,"vega-lite/src/aggregate":32,"vega-lite/src/channel":33,"vega-lite/src/mark":35,"vega-lite/src/timeunit":37,"vega-lite/src/type":38}],4:[function(require,module,exports){
"use strict";
/**
...
},{"./encoding":6,"./spec":7}],6:[function(require,module,exports){
"use strict";
 ...
 */
function checkEncoding(prop, indexTuple, specM, schema, stats, opt) {
    ...
    for (var i = 0; i < encodingConstraints.length; i++) {
        ...
        if (c.strict() || !!opt[c.name()]) {
            ...
            var satisfy = c.satisfy(encQ, schema, stats, opt);
            if (!satisfy) {
...
},{"../property":13,"../query":14,"../schema":20,"../util":22,"./base":4,"vega-lite/src/channel":33,"vega-lite/src/type":38}],7:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
var SpecConstraintModel = (function (_super) {
    ...
    SpecConstraintModel.prototype.satisfy = function (specM, schema, stats, opt) {
        // TODO: Re-order logic to optimize the "requireAllProperties" check
        if (this.constraint.requireAllProperties) {
            // TODO: extract as a method and do unit test
        ...
        return this.constraint.satisfy(specM, schema, stats, opt);
    };
...
exports.SPEC_CONSTRAINTS = [
    {
        ...
        requireAllProperties: false,
        strict: true,
        satisfy: function (specM, schema, stats, opt) {
            var usedChannel = {};
 ...
 * Check all encoding constraints for a particular property and index tuple
 */
function checkSpec(prop, indexTuple, specM, schema, stats, opt) {
    // Check encoding constraint
    ...
    for (var i = 0; i < specConstraints.length; i++) {
        ...
        if (c.strict() || !!opt[c.name()]) {
            // For strict constraint, or enabled non-strict, check the constraints
            var satisfy = c.satisfy(specM, schema, stats, opt);
            if (!satisfy) {
...
},{"../property":13,"../query":14,"../util":22,"./base":4,"vega-lite/src/aggregate":32,"vega-lite/src/channel":33,"vega-lite/src/mark":35,"vega-lite/src/type":38}],8:[function(require,module,exports){
"use strict";
...
},{"./constraint/constraint":5,"./enumerator":9,"./generate":10,"./model":11,"./nest":12,"./property":13,"./query":14,"./ranking/ranking":19,"./schema":20,"./stats":21,"./util":22}],9:[function(require,module,exports){
"use strict";
...
exports.ENUMERATOR_INDEX[property_1.Property.MARK] = function (enumSpecIndex, schema, stats, opt) {
    return function (answerSet, specM) {
        ...
        markEnumSpec.values.forEach(function (mark) {
            ...
            var violatedSpecConstraint = spec_1.checkSpec(property_1.Property.MARK, enumSpecIndex.mark, specM, schema, stats, opt);
            ...
            function enumerate(jobIndex) {
                ...
                encQ.autoCount === false ||
                    ...
                    propEnumSpec.values.forEach(function (propVal) {
                        ...
                        // Check encoding constraint
                        var violatedEncodingConstraint = encoding_1.checkEncoding(prop, indexTuple, specM, schema, stats, opt);
                        if (violatedEncodingConstraint) {
                            return; // do not keep searching
                        }
                        // Check spec constraint
                        var violatedSpecConstraint = spec_1.checkSpec(prop, indexTuple, specM, schema, stats, opt);
                        if (violatedSpecConstraint) {
                            return; // do not keep searching
                        }
...
},{"./constraint/encoding":6,"./constraint/spec":7,"./property":13}],10:[function(require,module,exports){
"use strict";
var enumerator_1 = require('../src/enumerator');
var config_1 = require('./config');
var model_1 = require('./model');
var util_1 = require('./util');
function generate(specQ, schema, stats, opt) {
    if (opt === void 0) { opt = {}; }
    ...
    opt.propertyPrecedence.forEach(function (prop) {
        ...
        if (enumSpecIndex[prop]) {
            // update answerset
            var reducer = enumerator_1.ENUMERATOR_INDEX[prop](enumSpecIndex, schema, stats, opt);
...
},{"../src/enumerator":9,"./config":3,"./model":11,"./util":22}],11:[function(require,module,exports){
"use strict";
var aggregate_1 = require('vega-lite/src/aggregate');
var type_1 = require('vega-lite/src/type');
var property_1 = require('./property');
...
var SpecQueryModel = (function () {
    ...
    SpecQueryModel.build = function (specQ, schema, opt) {
        specQ = util_1.duplicate(specQ); // preventing side-effect
        var enumSpecIndex = {};
        // mark
...
},{"./property":13,"./query":14,"./util":22,"vega-lite/src/aggregate":32,"vega-lite/src/type":38}],12:[function(require,module,exports){
"use strict";
var channel_1 = require('vega-lite/src/channel');
var query_1 = require('./query');
/**
 ...
 * @return
 */
function nest(specModels, query, stats) {
...
},{"./query":14,"vega-lite/src/channel":33}],13:[function(require,module,exports){
"use strict";
(function (Property) {
...
var util_1 = require('./util');
function query(query, schema, stats) {
    query = normalize(query);
    var answerSet = generate_1.generate(query.spec, schema, stats, query.config);
    var nestedAnswerSet = nest_1.nest(answerSet, query, stats);
    return ranking_1.rank(nestedAnswerSet, query, stats, 0);
}
exports.query = query;
/**
...
function stringifyEncodingQueryFieldDef(encQ) {
    ...
    var fieldType = enumSpecShort(encQ.field || '*') + ',' +
        ...
        params.map(function (p) { return ',' + p.key + '=' + p.value; });
    return (fn ? fn + '(' + fieldType + ')' : fieldType);
}
exports.stringifyEncodingQueryFieldDef = stringifyEncodingQueryFieldDef;

},{"./generate":10,"./nest":12,"./ranking/ranking":19,"./util":22,"vega-lite/src/channel":33,"vega-lite/src/mark":35,"vega-lite/src/stack":36,"vega-lite/src/type":38}],15:[function(require,module,exports){
"use strict";
var channel_1 = require('vega-lite/src/channel');
var config_1 = require('../../config');
var query_1 = require('../../query');
...
(function (TypeChannelScore) {
    ...
    function getScore(specM, stats, opt) {
...
},{"../../config":3,"../../query":14,"../../util":22,"./effectiveness":16,"./type":18,"vega-lite/src/channel":33}],16:[function(require,module,exports){
"use strict";
...
function default_1(specM, stats, opt) {
    var features = FEATURE_FACTORIES.reduce(function (f, factory) {
        var scores = factory.getScore(specM, stats, opt);
...
},{"./channel":15,"./mark":17}],17:[function(require,module,exports){
"use strict";
var channel_1 = require('vega-lite/src/channel');
var mark_1 = require('vega-lite/src/mark');
var util_1 = require('../../util');
...
},{"../../util":22,"./effectiveness":16,"./type":18,"vega-lite/src/channel":33,"vega-lite/src/mark":35}],18:[function(require,module,exports){
"use strict";
var type_1 = require('vega-lite/src/type');
/**
...
},{"vega-lite/src/type":38}],19:[function(require,module,exports){
"use strict";
var nest_1 = require('../nest');
...
exports.get = get;
function rank(group, query, stats, level) {
    if (!query.nest || level === query.nest.length) {
        ...
        group.items.forEach(function (subgroup) {
            rank(subgroup, query, stats, level + 1);
        });
...
},{"../nest":12,"./effectiveness/effectiveness":16}],20:[function(require,module,exports){
"use strict";
var Schema = (function () {
...
},{"datalib/src/util":2}],23:[function(require,module,exports){
...
},{"../time":26,"../util":27}],25:[function(require,module,exports){
var util = require('./util'),
    gen = module.exports;
...
},{"d3-time":23}],27:[function(require,module,exports){
(function (Buffer){
var u = module.exports;
...
},{"jsonify":29}],29:[function(require,module,exports){
...
},{"./channel":33,"./util":39}],35:[function(require,module,exports){
"use strict";
(function (Mark) {
...
},{"./channel":33,"./encoding":34,"./mark":35,"./util":39}],37:[function(require,module,exports){
"use strict";
(function (TimeUnit) {
...
},{"./channel":33,"./encoding":34,"datalib/src/bins/bins":24,"datalib/src/generate":25,"datalib/src/util":27,"json-stable-stringify":28}]},{},[8])(8)
});
