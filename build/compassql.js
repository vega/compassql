	    ...
	    },
	    {
	        ...
	        satisfy: function (specM, _, opt) {
	            ...
	            if (util_1$2.contains([mark_1$1.Mark.TICK, mark_1$1.Mark.BAR], mark)) {
	                if (specM.channelUsed(channel_1$1.Channel.SIZE)) {
