...
},{"./property":11,"./wildcard":35,"vega-lite/build/src/channel":52}],2:[function(require,module,exports){
"use strict";
/**
...
exports.FIELD_CONSTRAINTS = [
    {
        ...
        satisfy: function (fieldQ, _, encWildcardIndex, opt) {
            if (wildcard_1.isWildcard(fieldQ.channel))
            ...
            var supportedRole = channel_1.getSupportedRole(fieldQ.channel);
            if (encoding_1.isDimension(fieldQ)) {
                return supportedRole.dimension;
            }
            else if (encoding_1.isMeasure(fieldQ)) {
...
},{"../property":11,"../propindex":12,"../query/encoding":13,"../schema":32,"../util":34,"../wildcard":35,"./base":2,"vega-lite/build/src/channel":52,"vega-lite/build/src/scale":58,"vega-lite/build/src/type":60}],4:[function(require,module,exports){
"use strict";
...
exports.SPEC_CONSTRAINTS = [
        ...
        satisfy: function (specM, _, __) {
            ...
            if (mark === mark_1.Mark.BAR) {
                for (var _i = 0, encodings_1 = encodings; _i < encodings_1.length; _i++) {
                    ...
                    if (encoding_2.isFieldQuery(encQ) &&
    ...
    },
    {
        ...
        strict: false,
        satisfy: function (specM, _, __) {
            var hasAutoCount = util_1.some(specM.getEncodings(), function (encQ) { return encoding_2.isFieldQuery(encQ) && encQ.autoCount === true; });
            if (hasAutoCount) {
                ...
                var neverHaveAutoCount = util_1.every(autoCountEncIndex, function (index) {
                    var encQ = specM.getEncodingQueryByIndex(index);
                    return encoding_2.isFieldQuery(encQ) && !wildcard_1.isWildcard(encQ.autoCount);
                });
                if (neverHaveAutoCount) {
                    ...
                    return util_1.some(specM.getEncodings(), function (encQ) {
                        if (encoding_2.isFieldQuery(encQ) && encQ.type === type_1.Type.QUANTITATIVE) {
                        ...
                        else if (encoding_2.isFieldQuery(encQ) && encQ.type === type_1.Type.TEMPORAL) {
        ...
        satisfy: function (specM, _, opt) {
            if (specM.isAggregate()) {
                ...
                specM.specQuery.encodings.forEach(function (encQ, index) {
                    if (encoding_2.isValueQuery(encQ) || encQ.autoCount === false)
        ...
        satisfy: function (specM, _, __) {
            ...
            if (mark === mark_1.Mark.AREA || mark === mark_1.Mark.BAR) {
                for (var _i = 0, encodings_2 = encodings; _i < encodings_2.length; _i++) {
                    ...
                    if (encoding_2.isFieldQuery(encQ) && ((encQ.channel === channel_1.Channel.X || encQ.channel === channel_1.Channel.Y) && encQ.scale)) {
                ...
                case mark_1.Mark.LINE:
                    if (specM.isAggregate()) {
                        ...
                        return xEncQ && yEncQ && (xIsMeasure !== yIsMeasure) &&
                            ...
                            !(encoding_2.isFieldQuery(xEncQ) && !xIsMeasure && xEncQ.type === type_1.Type.NOMINAL) &&
                            !(encoding_2.isFieldQuery(yEncQ) && !yIsMeasure && yEncQ.type === type_1.Type.NOMINAL);
                    }
                    return true;
                case mark_1.Mark.TEXT:
    ...
    },
    {
        ...
        satisfy: function (specM, _, __) {
            ...
            if (stack) {
                ...
                return encoding_2.isFieldQuery(measureEncQ) && (util_1.contains(aggregate_1.SUM_OPS, measureEncQ.aggregate) || !!measureEncQ.autoCount);
            }
            return true;
        }
    },
...
},{"../property":11,"../propindex":12,"../query/encoding":13,"../util":34,"../wildcard":35,"./base":2,"vega-lite/build/src/aggregate":49,"vega-lite/build/src/channel":52,"vega-lite/build/src/mark":57,"vega-lite/build/src/scale":58,"vega-lite/build/src/type":60}],6:[function(require,module,exports){
"use strict";
...
},{"./config":1,"./constraint":4,"./enumerator":7,"./generate":8,"./model":9,"./nest":10,"./property":11,"./query/query":16,"./ranking/ranking":30,"./recommend":31,"./schema":32,"./util":34,"./wildcard":35}],7:[function(require,module,exports){
"use strict";
...
},{"./config":1,"./enumerator":7,"./model":9,"./property":11,"./stylize":33}],9:[function(require,module,exports){
"use strict";
var type_1 = require("vega-lite/build/src/type");
var property_1 = require("./property");
var wildcard_1 = require("./wildcard");
...
},{"./property":11,"./query/encoding":13,"./query/groupby":14,"./query/shorthand":17,"./query/spec":18,"./util":34,"./wildcard":35,"./wildcardindex":36,"vega-lite/build/src/type":60}],10:[function(require,module,exports){
"use strict";
var channel_1 = require("vega-lite/build/src/channel");
...
},{"./model":9,"./property":11,"./propindex":12,"./query/groupby":14,"./query/shorthand":17,"./query/spec":18,"datalib/src/util":44,"vega-lite/build/src/channel":52}],11:[function(require,module,exports){
"use strict";
...
},{"./util":34,"vega-lite/build/src/axis":50,"vega-lite/build/src/legend":55,"vega-lite/build/src/scale":58}],12:[function(require,module,exports){
"use strict";
var __assign = (this && this.__assign) || Object.assign || function(t) {
    for (var s, i = 1, n = arguments.length; i < n; i++) {
        s = arguments[i];
...
},{"./property":11,"./util":34}],13:[function(require,module,exports){
"use strict";
var type_1 = require("vega-lite/build/src/type");
...
},{"../util":34,"../wildcard":35,"vega-lite/build/src/compile/scale/type":53,"vega-lite/build/src/type":60}],14:[function(require,module,exports){
"use strict";
var util_1 = require("datalib/src/util");
...
},{"../property":11,"../propindex":12,"../util":34,"./shorthand":17,"datalib/src/util":44}],15:[function(require,module,exports){
"use strict";
var util_1 = require("../util");
/**
...
},{"../property":11,"../propindex":12,"../util":34,"../wildcard":35,"./encoding":13,"./spec":18,"datalib/src/util":44,"vega-lite/build/src/aggregate":49,"vega-lite/build/src/channel":52,"vega-lite/build/src/timeunit":59,"vega-lite/build/src/type":60}],18:[function(require,module,exports){
"use strict";
var channel_1 = require("vega-lite/build/src/channel");
var wildcard_1 = require("../wildcard");
var property_1 = require("../property");
...
},{"../property":11,"../util":34,"../wildcard":35,"./encoding":13,"vega-lite/build/src/channel":52}],19:[function(require,module,exports){
"use strict";
var type_1 = require("vega-lite/build/src/type");
var util_1 = require("../util");
var encoding_1 = require("../query/encoding");
...
},{"../query/encoding":13,"../util":34,"vega-lite/build/src/type":60}],20:[function(require,module,exports){
/**
...
},{"../../config":1,"./base":21,"./type":27,"vega-lite/build/src/channel":52}],21:[function(require,module,exports){
"use strict";
var Scorer = (function () {
...
},{"../../query/encoding":13,"./base":21}],23:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"../../config":1,"./base":21,"vega-lite/build/src/channel":52}],24:[function(require,module,exports){
"use strict";
...
},{"./axis":20,"./dimension":22,"./facet":23,"./mark":25,"./sizechannel":26,"./typechannel":28}],25:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"../../util":34,"./base":21,"./type":27,"vega-lite/build/src/channel":52,"vega-lite/build/src/mark":57}],26:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"../../query/encoding":13,"vega-lite/build/src/scale":58,"vega-lite/build/src/type":60}],28:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"../../query/shorthand":17,"../../util":34,"./base":21,"./type":27}],29:[function(require,module,exports){
"use strict";
var encoding_1 = require("../query/encoding");
...
},{"../query/encoding":13}],30:[function(require,module,exports){
"use strict";
function __export(m) {
...
},{"./aggregation":19,"./effectiveness":24,"./fieldorder":29}],31:[function(require,module,exports){
"use strict";
var __assign = (this && this.__assign) || Object.assign || function(t) {
    for (var s, i = 1, n = arguments.length; i < n; i++) {
        s = arguments[i];
...
},{"./config":1,"./generate":8,"./nest":10,"./query/normalize":15,"./ranking/ranking":30}],32:[function(require,module,exports){
"use strict";
var type_1 = require("vega-lite/build/src/type");
...
},{"./config":1,"./util":34,"datalib/src/bins/bins":39,"datalib/src/import/type":41,"datalib/src/stats":42,"vega-lite/build/src/bin":51,"vega-lite/build/src/timeunit":59,"vega-lite/build/src/type":60}],33:[function(require,module,exports){
"use strict";
var channel_1 = require("vega-lite/build/src/channel");
var scale_1 = require("vega-lite/build/src/scale");
var type_1 = require("vega-lite/build/src/type");
...
},{"./query/encoding":13,"vega-lite/build/src/channel":52,"vega-lite/build/src/scale":58,"vega-lite/build/src/type":60}],34:[function(require,module,exports){
"use strict";
var util_1 = require("datalib/src/util");
...
},{"datalib/src/util":44}],35:[function(require,module,exports){
"use strict";
var property_1 = require("./property");
var util_1 = require("./util");
var axis_1 = require("vega-lite/build/src/axis");
...
},{"./property":11,"./util":34,"vega-lite/build/src/axis":50,"vega-lite/build/src/channel":52,"vega-lite/build/src/legend":55,"vega-lite/build/src/mark":57,"vega-lite/build/src/scale":58,"vega-lite/build/src/timeunit":59,"vega-lite/build/src/type":60}],36:[function(require,module,exports){
"use strict";
var property_1 = require("./property");
var propindex_1 = require("./propindex");
...
},{"./property":11,"./propindex":12}],37:[function(require,module,exports){
...
},{"../time":43,"../util":44}],40:[function(require,module,exports){
var util = require('./util'),
    gen = module.exports;
...
},{"./generate":40,"./import/type":41,"./util":44}],43:[function(require,module,exports){
...
},{"d3-time":38}],44:[function(require,module,exports){
(function (Buffer){
...
},{"./channel":52}],52:[function(require,module,exports){
/*
...
},{"./scale":58,"./util":61}],53:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var log = require("../../log");
var channel_1 = require("../../channel");
...
},{"../../channel":52,"../../log":56,"../../scale":58,"../../util":61}],54:[function(require,module,exports){
...
},{"./log":56,"./util":61}],55:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./channel":52,"vega-util":62}],57:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var util_1 = require("./util");
var Mark;
...
},{"./log":56,"./util":61}],59:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./datetime":54,"./log":56,"./util":61}],60:[function(require,module,exports){
...
},{"json-stable-stringify":45,"vega-util":62}],62:[function(require,module,exports){
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports) :
