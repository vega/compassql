            ...
            switch (mark) {
                ...
                case mark_1.Mark.LINE:
                    if (specM.isAggregate()) {
                        ...
                        var xIsNonTemporalMeasure = encoding_1.isMeasure(xEncQ) &&
                            !(encoding_1.isFieldQuery(xEncQ) && xEncQ.type === 'temporal');
                        var yIsNonTemporalMeasure = encoding_1.isMeasure(yEncQ) &&
                            !(encoding_1.isFieldQuery(yEncQ) && yEncQ.type === 'temporal');
                        ...
                        return xEncQ && yEncQ && (xIsNonTemporalMeasure !== yIsNonTemporalMeasure) &&
                            ...
                            !(encoding_1.isFieldQuery(xEncQ) && !xIsNonTemporalMeasure && util_1.contains(['nominal', 'key'], xEncQ.type)) &&
                            !(encoding_1.isFieldQuery(yEncQ) && !yIsNonTemporalMeasure && util_1.contains(['nominal', 'key'], yEncQ.type));
...
},{"./property":13,"./query/encoding":15,"./query/groupby":17,"./query/shorthand":20,"./query/spec":21,"./util":38,"./wildcard":39,"./wildcardindex":40,"vega-lite/build/src/type":67}],12:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var channel_1 = require("vega-lite/build/src/channel");
